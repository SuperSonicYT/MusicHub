...
<html>
    <head>
        <title>All Time Favourites:Music hub</title>
    ...
    <div class="common">
        ...
        <ul class="menu">
            ...
            <li><a class="active" href="atf.php">ALL TIME FAVOURITES</a></li>
    ...
    <div class="recentbody">
        <div class="recent">
            <div id="product-grid">
                <p class="txt-heading" style="text-transform: uppercase; font-weight: bold; font-size:40;margin:0; margin-left:40%">ALL TIME FAVOURITES</p>
                <table>
                    <?php
                    $db_handle = new DBController();
	                $product_array = $db_handle->runQuery("SELECT * FROM music ORDER BY views DESC");
