...
<html>
    ...
    <div class="recentbody">
        <div class="recent">
            <div id="product-grid">
                <p class="txt-heading" style="text-transform: uppercase; font-weight: bold; font-size:40;margin:0; margin-left:40%">New Hits</p>
                <table>
                    <?php
                    $db_handle = new DBController();
	                $product_array = $db_handle->runQuery("SELECT * FROM music ORDER BY dor DESC");
